...
public class LiteChunkFileReader extends BukkitRunnable {
    ...
    public LiteChunkFileReader(RedstonePistonCap plugin, ChunkManager chunkManager) {
    ...
    public void run() {
        ...
        try {
            ...
            String coordinateFileDelimiter = String.valueOf(LiteChunkFileWriter.COORDINATE_FILE_DELIMITER);

            while (iterator.hasNext()) {
                line = iterator.nextLine();
                components = line.split(coordinateFileDelimiter);
